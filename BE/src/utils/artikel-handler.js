                ...
                <div class="card h-100 position-relative">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto d-flex justify-content-center">
                            <button type="button" id="edit-button" class="btn button-tambah px-4 me-2" data-bs-toggle="modal" data-bs-target="#editArtikelModal" data-id="${artikel.id}"><i class="bi bi-pencil"></i></button>
                            <button type="button" id="delete-button" class="btn px-4 btn-danger" data-id="${artikel.id}"><i class="bi bi-trash"></i></button>
                        </div>
                    </div>
                </div>
            </div>
